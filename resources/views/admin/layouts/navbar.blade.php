							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<a class="dropdown-item" href="#">Organization Profile</a>
										<div class="dropdown-divider"></div>
				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-section">
							...
							<h4 class="text-section">Organization</h4>
						</li>
						<li class="nav-item">
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="/abouts/1/edit">
											<span class="sub-item">Edit Details</span>
										</a>
									</li>
									<li>
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#employer">
								<i class="fas fa-layer-group"></i>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="location">
								<ul class="nav nav-collapse">
									<li>
										<a href="#">
											<span class="sub-item">All Locations</span>
										</a>
									</li>
									<li>
